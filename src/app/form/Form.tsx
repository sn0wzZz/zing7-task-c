...
export default function Form() {
  return (
    <div className='h-auto w-[80%] md:w-[70%] lg:w-[50%] xl:w-[60%] 2xl:w-[45%] flex  flex-col justify-center text-center py-10 xl:py-24'>
      ...
      <div className=' my-16 flex flex-nowrap justify-center'>
        ...
        <button className='p-3 xl:p-5 xl:px-10 bg-lime-200 xl:text-xl rounded-r-xl border-0 font-bold'>
          Изпрати
        </button>
      </div>
    </div>
